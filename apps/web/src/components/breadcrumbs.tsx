...
export function Breadcrumbs({
  ...
  return (
    <div
      className={cn(
        "border-y-[0.75px] border-zinc-900 bg-background",
        className
      )}
    >
      <div className="container flex min-h-13 items-center gap-2.5">
        <nav aria-label="Breadcrumb" className="min-w-0 flex-1">
          <ol className="flex min-w-0 items-center gap-1.5 text-muted-foreground text-sm leading-5 tracking-[0.24px]">
...
export function BreadcrumbsSkeleton() {
  return (
    <div className="border-b-[0.75px] border-zinc-900 bg-background">
